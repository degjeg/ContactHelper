...
import com.witness.utils.annotation.CompareAnnotation;
import com.witness.utils.common.TAStringUtils;
...
public class TADBUtils {
    ...
    public static String getTableName(Class<?> clazz) {
        DBTableName table = clazz.getAnnotation(DBTableName.class);
    ...
    public static List<TAPropertyEntity> getPropertyList(Class<?> clazz) {
        ...
        try {
            ...
            for (Field field : fields) {
                if (!TADBUtils.isTransient(field)) {
                    if (TADBUtils.isBaseDateType(field)) {
                        ...
                        CompareAnnotation compareAnnotation = field.getAnnotation(CompareAnnotation.class);
                        if (compareAnnotation != null) {
                            property.sequence = compareAnnotation.sortFlag();
                        }
            ...
            Collections.sort(plist, new Comparator<TAPropertyEntity>() {
                @Override
                public int compare(TAPropertyEntity lhs, TAPropertyEntity rhs) {
    ...
    public static boolean isTransient(Field field) {
        return field.getAnnotation(DBTransient.class) != null;
    }
    ...
    public static boolean isAutoIncrement(Field field) {
        DBPrimaryKey primaryKey = field.getAnnotation(DBPrimaryKey.class);
        if (null != primaryKey) {
